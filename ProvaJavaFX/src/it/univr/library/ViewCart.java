    ...
    public void buildCart(ArrayList<Book> books, VBox cartVBox, ScrollPane cartScrollPane)
    {
           ...
           GridPane orderGridPane;
            ...
            cartScrollPane.setVvalue(cartScrollPane.getVmin());
                ...
                for (Book book : books) {
                    createExternalLabel(orderGridPane, book);
                ...
                cartVBox.getChildren().add(orderGridPane);
        ...
        private void createExternalLabel(GridPane orderGridPane, Book book) {
            /* **** COLUMNS **** */
            ...
            totalPriceLabel.setText(book.getPrice() + "€");
            ...
            balancePointsLabel.setText(Integer.toString(book.getPoints()));
            ...
            GridPane.setConstraints(balancePointsHbox, 2, 2);

            /* *** ADD ALL THE LABELS TO GRID PANE */

            orderGridPane.getChildren().addAll(totalPriceHbox, balancePointsHbox);
